...
public enum  WebforumExceptionEnum {
    ...
    ADD_FAILED(10039,"新增分类失败"),
    CHECKBANNER_FAILED(10040,"该轮播帖子已存在"),
    ADDBANNER_FAILED(10041,"新增轮播失败"),
    DELETEBANNER_FAILED(10041,"删除轮播失败"),
    BANNER_EXISTED(10042,"轮播不存在"),
    COMMENT_EXISTED(10043,"该评论不存在"),
    REPLY_EXISTED(10043,"该回复不存在"),
    REPLY_FAILED(10044,"回复失败"),
    DELETE_REPLY_FAILED(10045,"删除回复失败"),
    SIGN_FAILED(10046,"签到失败"),
    GOOD_FAILED(10048,"点赞失败"),
    UNGOOD_FAILED(10049,"取消点赞失败"),
    USER_EXISTED(10047,"用户不存在"),
